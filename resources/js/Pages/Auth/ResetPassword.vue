...
<template>
    <Head title="Réinitialiser le mot de passe - JaaJ FM" />
        ...
        <div class="flex min-h-screen items-center justify-center p-6">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-white/80">Choisissez votre nouveau mot de passe sécurisé.</p>
                </div>
                ...
                <div class="glass rounded-2xl p-8">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            <label for="password" class="block text-white font-medium mb-2">Nouveau mot de passe</label>
                            <input
                                id="password"
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-white font-medium mb-2">Confirmer le mot de passe</label>
                            <input
                            ...
                            />
                            <div v-if="form.errors.password_confirmation" class="mt-2 text-red-400 text-sm">
