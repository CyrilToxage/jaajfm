<template>
    <header class="flex justify-between items-center mb-8 bg-white/10 p-4 rounded-2xl backdrop-blur-lg">
        <!-- Logo JaaJ FM -->
        <div class="flex items-center cursor-pointer" @click="goHome">
            <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 180 75"
                style="enable-background:new 0 0 180 75;" xml:space="preserve" class="h-16 w-auto">
                <g>
                    <defs>
                        <rect id="SVGID_1_" y="0" width="180" height="75" />
                    </defs>
                    <clipPath id="SVGID_00000059996360938322454710000015990677056596836762_">
                        <use xlink:href="#SVGID_1_" style="overflow:visible;" />
                    </clipPath>
                    <g style="clip-path:url(#SVGID_00000059996360938322454710000015990677056596836762_);">
        ...
        <!-- Barre de recherche -->
        <div class="flex-1 max-w-lg mx-5 relative">
            <MagnifyingGlassIcon class="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
            <input type="text" v-model="searchQuery" @keyup.enter="performSearch"
                placeholder="Rechercher des musiques, artistes ou playlists..."
                class="w-full pl-12 pr-16 py-3 rounded-full text-lg bg-white/90 backdrop-blur-lg border-none focus:outline-none focus:ring-2 focus:ring-purple-400" />
            <button @click="performSearch"
                class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-4 py-2 rounded-full hover:from-purple-700 hover:to-pink-700 transition-all duration-300">
